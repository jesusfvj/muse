        ...
        <div>
            <div className={`relative flex my-4 ${randomColor} overflow-hidden min-w-fit`}>
                <div className={' flex flex-col  place-content-between items-center p-2 w-[12rem] h-[15rem]'}>
                    ...
                    <div className={`w-[10rem] h-[10rem] ${bgImage} bg-cover bg-center bg-no-repeat min-h-[8rem] m-4 rotate-[35deg] absolute -bottom-8 -right-8 drop-shadow-[0_15px_15px_rgba(0,0,0,0.50)]`}>
                    </div>
                </div>
            </div>
