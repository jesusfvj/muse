    ...
    return (
        <div>
            <div className={`relative flex my-4 ${randomColor} overflow-hidden min-w-fit`}>
                <div className={' flex flex-col  place-content-between items-center p-2 w-[5rem] h-[7rem] sm:w-[12rem] sm:h-[15rem]'}>
                    <div className="w-full mt-2 px-3">
                        <Typography text={songTitle} type="p1" color="white" family="lato" styles='max-w-[200px] line-clamp-2 text-ellipsis' />
                    </div>
                    <div className={`w-[4rem] h-[4rem] m-1 sm:w-[10rem] sm:h-[10rem] ${bgImage} bg-cover bg-center bg-no-repeat min-h-[8rem] m-4 rotate-[35deg] absolute -bottom-8 -right-8 drop-shadow-[0_15px_15px_rgba(0,0,0,0.50)]`}>
                    </div>
                </div>
            </div>
