  ...
  const { artist, songTitle, album, year, producer, genre, bgImage } = object;
    return (
        <div className="relative flex my-4 min-w-fit">
            <div className={' bg-slate-900 rounded-[0.5rem] flex flex-col  place-content-between items-center p-2 sm:w-[12rem] sm:h-[15rem] '}>
                <div className={`sm:w-[8rem] sm:h-[8rem] w-[4rem] h-[4rem] rounded-full ${bgImage} bg-cover bg-center bg-no-repeat sm:min-h-[8rem] m-4`}>
                </div>
