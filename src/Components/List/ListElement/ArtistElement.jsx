  ...
  const {name, photoUrl} = object;
    return (
        <div className="relative flex my-4 min-w-fit select-none">
            <div className={' bg-slate-900 rounded-[0.5rem] flex flex-col  place-content-between items-center p-2  w-full h-full '}>
            <img
          src={photoUrl}
        ...
        />
                <div className="w-full mb-5 px-3 text-center">
                    <Typography text={name} type="p1" color="white" family="lato" styles=' sm:leading-6 line-clamp-2 text-ellipsis' />
