    ...
    return (
        <div className='w-[90%] sm:w-[30%]'>
            ...
            <form className='flex flex-col gap-4 pt-[1rem]'
                ...
                <InputElement text={text} name={name} type={type} value={valueOne} input={input} readonly={true}/>
                <InputElement text={text} name={nameTwo} type={type} value={valueTwo} input={input} onInputChange={onInputChange} />
                <div className="mt-[4rem] flex justify-start w-[10rem]">
                    <Button text="Save" typeButton="submit" color="black" size="sm" />
                </div>
            </form>
        </div>
    )
