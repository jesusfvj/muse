...
export const LandingPage = () => {
  ...
  return (
    <div className="items-center h-screen bg-[url('https://res.cloudinary.com/dmufnezzd/image/upload/v1684396023/muze-image_file-folder/LandBgImage_cdxwqx_1_psx46y.jpg')] bg-cover bg-left-bottom">
